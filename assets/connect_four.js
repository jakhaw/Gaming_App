      ...
      squares[i].onclick = () => {
        ...
        if (squares[i + 7].classList.contains('taken') && !squares[i].classList.contains('taken')) {
          if (currentPlayer == 1) {
            ...
            currentPlayerColor.classList.add('player-two-text')
            currentPlayerColor.classList.remove('player-one-text')
            ...
            displayCurrentPlayer.innerHTML = currentPlayer
            currentPlayerColor.classList.add('player-one-text')
            currentPlayerColor.classList.remove('player-two-text')
          } 
        } else {
          alert();
        }
